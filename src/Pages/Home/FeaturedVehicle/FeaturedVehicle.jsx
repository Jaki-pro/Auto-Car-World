    ...
    return (
        <div className='mt-8'>
            <div className='text-center mb-8 '>
                ...
                <h1 className='text-5xl font-bold'>Featured Vehicles</h1>
            </div>
            <div className="container bg-[#b2b4f7]  p-8 mx-auto">
                <Slider {...settings}>
                    {
                        cars.map((item) => (
                            <div  key={item.car_id} className='card p-4  bg-[#9496f7]  shadow-xl border-2 h-72'>
