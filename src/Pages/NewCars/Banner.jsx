    ...
    <div id="slide1" className="carousel-item relative w-full mb-16">
        ...
        <div className="absolute  transform flex items-center bottom-0 md:pl-12 top-0 bg-gradient-to-r from-[#151515] to-[rgb(21, 21, 21,20)]">
            <div className='pt-2 md:pt-8 w-full px-8 '>
                {
                    location.pathname == '/repairs' ? <h2 className='text-white font-semibold font-serif lg:text-6xl md:text-5xl  sm:text-4xl text-xl'>Awsome Services</h2> : <h2 className='text-white font-semibold font-serif lg:text-6xl md:text-5xl  sm:text-4xl text-xl'>Awsome Cars</h2>
                }
                <p className='text-white leading-4'>There are many variations of passages of  available, but the majority  </p>
                <div className='flex justify-between items-center'>
                    <h2 className='text-white font-bold md:text-3xl text-sm w-full font-mono'>Subscribe Youtube</h2>
